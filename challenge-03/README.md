...
pessoa.andar = function(metros) {
    pessoa.caminouQuantosMetros += metros;
    pessoa.andando = true;
};
...
*/
pessoa.nomeCompleto(); //"Olá! meu nome é Marcella Caffer!"
...
// Agora, apresente-se ;)
"Olá, eu sou a Marcella Caffer, tenho 31 anos, 1.64, meu peso é 64 e, só hoje, eu já caminhei 20 metros!"
```
